...
The [`htobit2018`](https://R-Forge.R-project.org/projects/uibk-rprog-2018/) package
...
a better implementation in the package `crch`. The main purpose of `htobit2018` is
